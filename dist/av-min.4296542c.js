  ...
  return function (t) {
    ...
    (function (t, n) {
      var r, i;!function () {
        var s = "object" == (typeof self === "undefined" ? "undefined" : _typeof(self)) && self.self === self && self || "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) && t.global === t && t || this || {},
        ...
        };void 0 === e || e.nodeType ? s._ = m : (void 0 !== n && !n.nodeType && n.exports && (e = n.exports = m), e._ = m), m.VERSION = "1.9.0";var g,
            b = function b(t, e, n) {
          ...
          for (var n = e.length, r = 0; r < n; r++) {
            ...
            T = A("length"),
            N = function N(t) {
          var e = T(t);return "number" == typeof e && e >= 0 && e <= E;
        };m.each = m.forEach = function (t, e, n) {
          e = b(e, n);var r, i;if (N(t)) for (r = 0, i = t.length; r < i; r++) {
            e(t[r], r, t);
          } else {
          ...
          e = w(e, n);for (var r = !N(t) && m.keys(t), i = (r || t).length, s = Array(i), o = 0; o < i; o++) {
            var a = r ? r[o] : o;s[o] = e(t[a], a, t);
          }return s;
        };var j = function j(t) {
          var e = function e(_e, n, r, i) {
            var s = !N(_e) && m.keys(_e),
                o = (s || _e).length,
          ...
          e = w(e, n);for (var r = !N(t) && m.keys(t), i = (r || t).length, s = 0; s < i; s++) {
          ...
          var r, i;return m.isFunction(e) ? i = e : m.isArray(e) && (r = e.slice(0, -1), e = e[e.length - 1]), m.map(t, function (t) {
            var s = i;if (!s) {
              if (r && r.length && (t = C(t, r)), null == t) return;s = t[e];
          ...
          var r,
            ...
            t = N(t) ? t : m.values(t);for (var a = 0, u = t.length; a < u; a++) {
              null != (r = t[a]) && r > s && (s = r);
            }
          ...
          if (null == e || n) return N(t) || (t = m.values(t)), t[m.random(t.length - 1)];var r = N(t) ? m.clone(t) : m.values(t),
              i = T(r);e = Math.max(Math.min(e, i), 0);for (var s = i - 1, o = 0; o < e; o++) {
            var a = m.random(o, s),
                u = r[o];r[o] = r[a], r[a] = u;
          }return r.slice(0, e);
        ...
        };m.groupBy = x(function (t, e, n) {
          m.has(t, n) ? t[n].push(e) : t[n] = [e];
        }), m.indexBy = x(function (t, e, n) {
          t[n] = e;
        }), m.countBy = x(function (t, e, n) {
          m.has(t, n) ? t[n]++ : t[n] = 1;
        });var U = /[^\ud800-\udfff]|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udfff]/g;m.toArray = function (t) {
          ...
          if (!(null == t || t.length < 1)) return null == e || n ? t[t.length - 1] : m.rest(t, Math.max(0, t.length - e));
          ...
          r = r || [];for (var i = r.length, s = 0, o = T(t); s < o; s++) {
            var a = t[s];if (N(a) && (m.isArray(a) || m.isArguments(a))) {
          ...
          m.isBoolean(e) || (r = n, n = e, e = !1), null != n && (n = w(n, r));for (var i = [], s = [], o = 0, a = T(t); o < a; o++) {
            var u = t[o],
          ...
          return function (e, n, r) {
            n = w(n, r);for (var i = T(e), s = t > 0 ? 0 : i - 1; s >= 0 && s < i; s += t) {
              if (n(e[s], s, e)) return s;
            }return -1;
          };
        };m.findIndex = I(1), m.findLastIndex = I(-1), m.sortedIndex = function (t, e, n, r) {
          n = w(n, r, 1);for (var i = n(e), s = 0, o = T(t); s < o;) {
            var a = Math.floor((s + o) / 2);n(t[a]) < i ? s = a + 1 : o = a;
          }return s;
        };var R = function R(t, e, n) {
          return function (r, i, s) {
            var o = 0,
                a = T(r);if ("number" == typeof s) t > 0 ? o = s >= 0 ? s : Math.max(s + a, o) : a = s >= 0 ? Math.min(s + 1, a) : s + a + 1;else if (n && s && a) return s = n(r, i), r[s] === i ? s : -1;if (i !== i) return s = e(h.call(r, o, a), m.isNaN), s >= 0 ? s + o : -1;for (s = t > 0 ? o : a - 1; s >= 0 && s < a; s += t) {
              if (r[s] === i) return s;
            }return -1;
          };
          ...
          if (!(r instanceof e)) return t.apply(n, i);var s = S(t.prototype),
          ...
          var n = function n(r) {
            var i = n.cache,
                s = "" + (e ? e.apply(this, arguments) : r);return m.has(i, s) || (i[s] = t.apply(this, arguments)), i[s];
          };return n.cache = {}, n;
        ...
        }, m.once = m.partial(m.before, 2), m.restArguments = O;var D = !{ toString: null }.propertyIsEnumerable("toString"),
            F = ["valueOf", "isPrototypeOf", "toString", "propertyIsEnumerable", "hasOwnProperty", "toLocaleString"],
            L = function L(t, e) {
          var n = F.length,
              r = t.constructor,
              i = m.isFunction(r) && r.prototype || u,
              s = "constructor";for (m.has(t, s) && !m.contains(e, s) && e.push(s); n--;) {
        ...
        };m.extend = q(m.allKeys), m.extendOwn = m.assign = q(m.keys), m.findKey = function (t, e, n) {
          ...
          var n = {},
              r = e[0];if (null == t) return n;m.isFunction(r) ? (e.length > 1 && (r = b(r, e[1])), e = m.allKeys(t)) : (r = M, e = k(e, !1, !1), t = Object(t));for (var i = 0, s = e.length; i < s; i++) {
            var o = e[i],
                a = t[o];r(a, o, t) && (n[o] = a);
          }return n;
        ...
        }), m.defaults = q(m.allKeys, !0), m.create = function (t, e) {
          var n = S(t);return e && m.extendOwn(n, e), n;
        }, m.clone = function (t) {
          ...
          t instanceof m && (t = t._wrapped), e instanceof m && (e = e._wrapped);var i = f.call(t);if (i !== f.call(e)) return !1;switch (i) {case "[object RegExp]":case "[object String]":
            ...
            var l,
              ...
              if (l = h[u], !m.has(e, l) || !B(t[l], e[l], n, r)) return !1;
            }
          ...
          if (!m.isArray(e)) return null != t && d.call(t, e);for (var n = e.length, r = 0; r < n; r++) {
        ...
        };m.escape = K(W), m.unescape = K(V), m.result = function (t, e, n) {
          ...
          !e && n && (e = n), e = m.defaults({}, e, m.templateSettings);var r = RegExp([(e.escape || H).source, (e.interpolate || H).source, (e.evaluate || H).source].join("|") + "|$", "g"),
            ...
            return s += t.slice(i, a).replace($, X), i = a + e.length, n ? s += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : r ? s += "'+\n((__t=(" + r + "))==null?'':__t)+\n'" : o && (s += "';\n" + o + "\n__p+='"), e;
          ...
          return m.each(m.functions(t), function (e) {
            var n = m[e] = t[e];m.prototype[e] = function () {
              var t = [this._wrapped];return l.apply(t, arguments), Y(this, n.apply(m, t));
            };
          }), m;
        }, m.mixin(m), m.each(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], function (t) {
          var e = a[t];m.prototype[t] = function () {
            var n = this._wrapped;return e.apply(n, arguments), "shift" !== t && "splice" !== t || 0 !== n.length || delete n[0], Y(this, n);
          };
    ...
    n(15);var r = n(5);r._ = n(0), r.version = n(9), r.Promise = n(1), r.localStorage = n(11), r.Cache = n(12), r.Error = n(4), n(30), n(32)(r), n(33)(r), n(34)(r), n(35)(r), n(36)(r), n(37)(r), n(45)(r), n(46)(r), n(47)(r), n(48)(r), n(49)(r), n(51)(r), n(52)(r), n(53)(r), n(54)(r), n(55)(r), n(56)(r), r.Conversation = n(57), t.exports = r;
  }, function (t, e, n) {
    "use strict";
  }, function (t, e) {
      ...
      */
      !function (e, n) {
        ...
        function t(t) {
          ...
          t._state === X && (t._result = e, t._state = Y, 0 !== t._subscribers.length && J(A, t));
        }function O(t, e) {
          t._state === X && (t._state = Z, t._result = e, J(b, t));
        }function S(t, e, n, r) {
          var i = t._subscribers,
              s = i.length;t._onerror = null, i[s] = e, i[s + Y] = n, i[s + Z] = r, 0 === s && t._state && J(A, t);
        }function A(t) {
          ...
          var e = this;return new e(L(t) ? function (n, r) {
          ...
          try {
            ...
            nt = function () {
          function t(t, e) {
            this._instanceConstructor = t, this.promise = new t(h), this.promise[$] || j(this.promise), L(e) ? (this.length = e.length, this._remaining = e.length, this._result = new Array(this.length), 0 === this.length ? w(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(e), 0 === this._remaining && w(this.promise, this._result))) : O(this.promise, x());
    ...
    function r(t, e) {
      ...
      t.Object = function (e, n) {
        ...
        t._traverse(e, function (e) {
          return e instanceof t.Object ? void (e.dirty() && n.push(e)) : e instanceof t.File ? void (e.url() || e.id || r.push(e)) : void 0;
        });
    ...
    function r(t, e, n) {
      ...
      t.User = t.Object.extend("_User", { _isCurrentUser: !1, _mergeMagicFields: function _mergeMagicFields(e) {
          ...
          var s,
              o = this;return i.isString(e) ? (s = e, e = t.User._authProviders[e]) : s = e.getAuthType(), n ? this.save({ authData: r({}, s, n) }, { fetchWhenSave: !!this.get("authData") }).then(function (t) {
          ...
          return this.signUpOrlogInWithAuthData(h(t, n, r), e);
...
},{"process":14}],16:[function(require,module,exports) {
...
//# sourceMappingURL=/av-min.4296542c.map