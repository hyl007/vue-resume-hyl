...
window.Appmain = {
    ...
    data: function data() {
        return {
            resume: {
                ...
                email: '99999@qq.com',
                gitHub: 'github.com',
                skills: [{ name: '技能名', description: '技能描述' }, { name: '技能名', description: '技能描述' }, { name: '技能名', description: '技能描述' }],
                projects: [{ name: '项目名称', description: '项目描述' }, { name: '项目名称', description: '项目描述' }, { name: '项目名称', description: '项目描述' }, { name: '项目名称', description: '项目描述' }]
            },
            editShow: false,
            isShare: false,
            currentUser: { id: '' },
    ...
    methods: {
        ...
        saveMain: function saveMain() {
            ...
            if (AV.User.current()) {
                var _AV$User$current$toJS = AV.User.current().toJSON(),
                    objectId = _AV$User$current$toJS.objectId;

                var user = AV.Object.createWithoutData('User', objectId);
                user.set('resume', this.resume);
                user.save().then(function () {
                    alert('保存成功');
                    _this.getResume(objectId);
        ...
        getResume: function getResume(user) {
            var _this2 = this;

            var query = new AV.Query('User');
            return query.get(user).then(function (user) {
                if (user.toJSON().resume) {
                    _this2.resume = user.toJSON().resume;
                }
            }, function (error) {});
        },
        ...
        changeResume: function changeResume(e) {
            this.resume = e;
        },
...
//# sourceMappingURL=/app.679990b4.map